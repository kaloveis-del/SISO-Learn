...
- [x] 12.4 iPad Air M1 / M5 시뮬레이터 테스트 (Xcode 빌드 후 수동 확인)
- [x] 12.5 App Store Connect 앱 등록 및 TestFlight 설정 (Apple Developer 계정 필요)
- [x] 12.6 내부 테스터(두 딸) 초대 및 TestFlight 배포 (12.5 완료 후 진행)
- [x] 12.7 피드백 수집 및 버그 수정 (배포 후 진행)
